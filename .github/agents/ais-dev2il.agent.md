...
Have additional examples and follow ups available for students that are faster and for homework

If required, there can be multiple of such blocks (theory + self study) in a single session (e.g. per topic)

The students are not very far in their studies. They only had 1 semester of Python basics. how AI should behave: response style, available tools, focus areas, and any mode-specific instructions or constraints.